...
import { FormRender, ReportTemplate, HOCReportRender } from '@deer-ui/admin-scaffold/template-engine';
...
```js
import ReportTemplate from '@deer-ui/admin-scaffold/template-engine/for-report/dataRows-template'
